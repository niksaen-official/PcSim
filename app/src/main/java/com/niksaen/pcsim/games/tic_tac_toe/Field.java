...
public class Field extends RecyclerView.Adapter<Field.ViewHolder>{
    ...
    public Button reset;
    public Field(MainActivity activity){
        this.activity = activity;
    }
    @NonNull
    @Override
    public Field.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull Field.ViewHolder holder, int position) {
        if(field[position] == "b"){
