...
public class AppDownloaderListAdapter extends ArrayAdapter<String> {
    ...
    @Override
    public int getCount() {
        return Program.programList.length;
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        textView.setText(words.get(Program.programList[position]));
        ImageView image = main.findViewById(R.id.app_icon);
        image.setImageResource(Program.programIcon.get(Program.programList[position]));
        return main;
    }
}
